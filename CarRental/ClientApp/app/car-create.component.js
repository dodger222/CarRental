...
var CarCreateComponent = /** @class */ (function () {
    function CarCreateComponent(dataService, router) {
        this.dataService = dataService;
        this.router = router;
        this.car = new Car(); // добавляемый объект
    }
    CarCreateComponent.prototype.save = function () {
        var _this = this;
        this.dataService.createCar(this.car).subscribe(function (data) { return _this.router.navigateByUrl("/CarList"); });
    };
